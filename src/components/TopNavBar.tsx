...
const TopNavBar: React.FC = () => {
  ...
  const descriptions = profileConfig.featureDescriptions as Record<
    string,
    string
  >;
        ...
        <div className="flex items-center p-2 gap-4  w-full justify-between">
          <div className="flex items-center gap-2 h-8">
            ...
            >
              ...
              {showToolTip === "menu" && (
                <div className="absolute bottom-[-30px] left-1 transform -translate-x-1/2 bg-black text-white text-xs rounded-md px-2 py-1 whitespace-nowrap ">
                  {nav.menu}
                </div>
              )}
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              >
                ...
                <span className="hover:text-white text-[#7d8590]">
