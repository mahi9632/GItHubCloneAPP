...
const AppRouter: React.FC = () => {
  const createPageElement = (
    ...
    const Content =
      ContentComponent ?? (() => <p>{`This is the ${displayTitle} Page.`}</p>);
        ...
        <div>
          <Routes>
            ...
            <Route
              ...
              element={createPageElement("repositories")}
            />
            <Route
              path="/profile/:username/projects"
              element={createPageElement("Projects")}
            />
            <Route
              path="/profile/:username/stars"
              element={createPageElement("Stars")}
            />
            <Route
              path="/profile/:username/packages"
              element={createPageElement("Packages")}
            />
